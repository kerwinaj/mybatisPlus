...
CREATE TABLE user_hobby (
    id BIGINT(20) PRIMARY KEY NOT NULL COMMENT '主键',
    user_id BIGINT(20) NOT NULL COMMENT '姓名',
    hobby VARCHAR(50) DEFAULT NULL COMMENT '兴趣'
)  ENGINE=INNODB CHARSET=UTF8;

INSERT INTO `user_hobby` (`id`, `user_id`, `hobby`) VALUES ('1', '1087982257332887553', '管理');
INSERT INTO `user_hobby` (`id`, `user_id`, `hobby`) VALUES ('2', '1088248166370832385', '向上管理');
INSERT INTO `user_hobby` (`id`, `user_id`, `hobby`) VALUES ('3', '1088250446457389058', '学');
INSERT INTO `user_hobby` (`id`, `user_id`, `hobby`) VALUES ('4', '1094590409767661570', '学');
INSERT INTO `user_hobby` (`id`, `user_id`, `hobby`) VALUES ('5', '1094592041087729666', '学');
